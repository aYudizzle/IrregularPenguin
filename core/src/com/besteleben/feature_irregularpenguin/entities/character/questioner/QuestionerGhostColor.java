...
public enum QuestionerGhostColor {
    ...
    /**
     * Constructor for the QuestionGhostColor, which defines the names of the different color regions
     *
